object Fescrito: TFescrito
  ...
  object cxGroupBox1: TcxGroupBox
    ...
    object cxLookupComboBox1: TcxLookupComboBox
      ...
      Properties.ListSource = DM.DSestados
      TabOrder = 3
      Width = 145
    end
    object cxLookupComboBox2: TcxLookupComboBox
      Left = 624
      Top = 48
      Properties.KeyFieldNames = 'IDIOMA'
      Properties.ListColumns = <
        item
          FieldName = 'IDIOMA'
        end>
      Properties.ListSource = DM.DSidiomas
      TabOrder = 4
      Width = 145
    end
    object cxLookupComboBox3: TcxLookupComboBox
      Left = 624
      Top = 103
      Properties.KeyFieldNames = 'Tipo de documento'
      Properties.ListColumns = <
        item
          FieldName = 'Tipo de documento'
        end>
      Properties.ListSource = DM.DStipodoc
      TabOrder = 5
      Width = 145
    end
    ...
    object cxlavel9: TcxLabel
      Left = 463
      Top = 87
      Caption = 'REFERENCIA TEMATICA'
      Transparent = True
    end
  ...
  object cxGroupBox2: TcxGroupBox
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = DM.DSescrito
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            ...
            Column = cxGrid1DBTableView1FECHAENTRADA
          end>
        ...
        object cxGrid1DBTableView1FECHASALIDA: TcxGridDBColumn
          DataBinding.FieldName = 'FECHA SALIDA'
        end
        ...
        object cxGrid1DBTableView1CUANTILLAS: TcxGridDBColumn
          DataBinding.FieldName = 'CUANTILLAS'
          Width = 66
        end
        ...
        object cxGrid1DBTableView1URGENTENOURGENTE: TcxGridDBColumn
          DataBinding.FieldName = 'URGENTE/NO URGENTE'
          Width = 136
        end
        object cxGrid1DBTableView1REFERENCIATEMATICA: TcxGridDBColumn
          DataBinding.FieldName = 'REFERENCIA TEMATICA'
          Width = 424
        end
        object cxGrid1DBTableView1USUARIO: TcxGridDBColumn
          DataBinding.FieldName = 'USUARIO'
        end
        object cxGrid1DBTableView1IDESCRITO: TcxGridDBColumn
          DataBinding.FieldName = 'IDESCRITO'
        end
      end
