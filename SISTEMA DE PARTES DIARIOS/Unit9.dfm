object Fllamadas: TFllamadas
  ...
  object cxGroupBox1: TcxGroupBox
    ...
    object cxLabel2: TcxLabel
      Left = 208
      Top = 24
      Caption = 'Llamadas entradas'
      Transparent = True
    end
    object cxLabel3: TcxLabel
      Left = 376
      Top = 24
      Caption = 'llamadas sin inter'#233's'
      Transparent = True
    end
    object cxLabel4: TcxLabel
      Left = 544
      Top = 24
      Caption = 'Llamadas con inter'#233's'
      Transparent = True
    end
    ...
    object cxLabel6: TcxLabel
      Left = 40
      Top = 80
      Caption = 'P'#250'blicas aplicadas'
      Transparent = True
    end
    object cxLabel7: TcxLabel
      Left = 208
      Top = 80
      Caption = 'MCC entradas'
      Transparent = True
    end
    object cxLabel8: TcxLabel
      Left = 376
      Top = 80
      Caption = 'MCC con inter'#233's'
      Transparent = True
    end
    object cxLabel10: TcxLabel
      Left = 544
      Top = 80
      Caption = 'MCC sin  inter'#233's'
      Transparent = True
    end
    object cxLabel11: TcxLabel
      Left = 719
      Top = 80
      Caption = 'MCC pendiente'
      Transparent = True
    end
    object cxLabel9: TcxLabel
      Left = 719
      Top = 24
      Caption = 'Llamadas pendientes'
      Transparent = True
    end
  ...
  object cxGroupBox2: TcxGroupBox
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = DM.DSQBYUllamadas
        ...
        object cxGrid1DBTableView1IDLLAMADAS: TcxGridDBColumn
          DataBinding.FieldName = 'IDLLAMADAS'
          Width = 68
        end
      end
