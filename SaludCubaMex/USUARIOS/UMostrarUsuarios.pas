...
type
  TFMostrarUsuarios = class(TForm)
    ...
    cxGrid1DBTableView1FECHA_CREADO: TcxGridDBColumn;
...
var
  FMostrarUsuarios: TFMostrarUsuarios;
...
procedure TFMostrarUsuarios.FormActivate(Sender: TObject);
begin
  try
     FDMUsuarios.QMostrarUsuarios.Execute;
...
procedure TFMostrarUsuarios.FormClose(Sender: TObject;
