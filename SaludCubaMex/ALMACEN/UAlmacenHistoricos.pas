...
type
  TFAlmacenHistoricos = class(TForm)
...
var
  FAlmacenHistoricos: TFAlmacenHistoricos;

implementation
 USES UDMAlmacen;
{$R *.dfm}

procedure TFAlmacenHistoricos.cxButton3Click(Sender: TObject);
begin
    if (cxDateEdit3.Text <> '') and (cxDateEdit2.Text <> '') then
    begin
      try
        FDMAlmacen.QAlmacenHistoricos.ParamByName('FECHADESDE').AsDate:=cxDateEdit2.Date;
        FDMAlmacen.QAlmacenHistoricos.ParamByName('FECHAHASTA').AsDate:=cxDateEdit3.Date;
        FDMAlmacen.QAlmacenHistoricos.Execute;
...
procedure TFAlmacenHistoricos.FormActivate(Sender: TObject);
begin
    cxDateEdit3.Date:=Now;
    //CXDATE
end;

procedure TFAlmacenHistoricos.FormClose(Sender: TObject;
