...
type
  TFormUsuarios = class(TForm)
    ...
    cxGrid1DBTableView1Telefono1: TcxGridDBColumn;
    cxGrid1DBTableView1Extension: TcxGridDBColumn;
    cxGrid1DBTableView1AccesoComedor: TcxGridDBColumn;
    cxGrid1DBTableView1Status: TcxGridDBColumn;
    cxGrid1DBTableView1CantidadComidas: TcxGridDBColumn;
