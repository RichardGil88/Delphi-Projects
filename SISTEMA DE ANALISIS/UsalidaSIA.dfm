object FsalidaSIA: TFsalidaSIA
  Left = 0
  Top = 0
  Caption = 'Salida de ficheros de llamadas por la SIA'
  ClientHeight = 687
  ClientWidth = 789
  Color = clBtnFace
  ...
  object cxGroupBox1: TcxGroupBox
    ...
    object cxLabel5: TcxLabel
      Left = 268
      Top = 20
      Caption = 'Cant. de llamadas'
      Transparent = True
    end
    object cxLabel3: TcxLabel
      Left = 397
      Top = 20
      Caption = 'Expediente - Caso'
      Transparent = True
    end
  ...
  object cxGroupBox2: TcxGroupBox
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = DM.DSsalidaSIA
        ...
        object cxGrid1DBTableView1APROBADOPOR: TcxGridDBColumn
          Caption = 'APROBADO POR'
          DataBinding.FieldName = 'APROBADOPOR'
          Width = 102
        end
        object cxGrid1DBTableView1CANTLLAMADAS: TcxGridDBColumn
          Caption = 'CANT LLAMADAS'
          DataBinding.FieldName = 'CANTLLAMADAS'
          Width = 162
        end
        object cxGrid1DBTableView1EXPTECASO: TcxGridDBColumn
          Caption = 'EXP TECASO'
          DataBinding.FieldName = 'EXPTECASO'
          Width = 101
        end
        ...
        object cxGrid1DBTableView1ENTREGADOA: TcxGridDBColumn
          Caption = 'ENTREGADO  A'
          DataBinding.FieldName = 'ENTREGADOA'
          Width = 120
        end
