...
type
  TFmodificarusuario = class(TForm)
...
var
  Fmodificarusuario: TFmodificarusuario;

implementation
uses Ulogin, UDM;
{$R *.dfm}

procedure TFmodificarusuario.cxButton2Click(Sender: TObject);
begin
Close;
end;

procedure TFmodificarusuario.cxButton1Click(Sender: TObject);
begin
...
procedure TFmodificarusuario.FormShow(Sender: TObject);
begin
 with DM do
     begin
       Quser1.Active:=True;
