...
type
  TFusuarioscargo = class(TForm)
    cxGrid1: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    cxgrdbclmnGridDBTableView1cargo: TcxGridDBColumn;
    cxgrdbclmnGridDBTableView1activo: TcxGridDBColumn;
    cxgrdbclmnGridDBTableView1nivel: TcxGridDBColumn;
...
var
  Fusuarioscargo: TFusuarioscargo;

implementation
 uses UDM;
{$R *.dfm}

procedure TFusuarioscargo.FormShow(Sender: TObject);
begin
