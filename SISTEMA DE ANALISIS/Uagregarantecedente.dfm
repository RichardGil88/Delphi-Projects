object Fagregarantecedente: TFagregarantecedente
  Left = 0
  Top = 0
  Caption = 'Agregar antecedente'
  ClientHeight = 602
  ClientWidth = 967
  Color = clBtnFace
  ...
  object cxGroupBox1: TcxGroupBox
    ...
    object cxGroupBox2: TcxGroupBox
      ...
      object cxLabel3: TcxLabel
        Left = 24
        Top = 101
        Caption = 'Forma de actividad delictiva o enemiga *'
        Transparent = True
      end
      object cxLabel4: TcxLabel
        Left = 300
        Top = 183
        Caption = 'Inter'#233's del caso'
        Transparent = True
      end
      ...
      object cxLabel10: TcxLabel
        Left = 457
        Top = 22
        Caption = 'Localizaci'#243'n del oficial'
        Transparent = True
      end
      ...
      object cxLookupComboBox4: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DSexpedientesoperativos
        EditValue = 'PROCESO INVESTIGATIVO/CASO'
        TabOrder = 17
        Width = 352
      end
      object cxLookupComboBox5: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DSnivelcompartimentacion
        EditValue = 'SECRETO'
        TabOrder = 10
        Width = 145
      end
      ...
      object cxLookupComboBox11: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DStipotec
        TabOrder = 21
        Width = 295
      end
      ...
      object cxLookupComboBox14: TcxLookupComboBox
        Left = 457
        Top = 76
        ...
        Properties.ListSource = DM.DSfinalidad
        TabOrder = 15
        Width = 195
      end
      object cxCheckBox1: TcxCheckBox
        Left = 24
        Top = 184
        Caption = 'Aplicaci'#243'n cumpli'#243' finalidad *'
        TabOrder = 26
        Transparent = True
      ...
      object cxLookupComboBox16: TcxLookupComboBox
        ...
        TabOrder = 24
        OnClick = cxLookupComboBox16Click
        Width = 352
      end
      object cxLabel43: TcxLabel
        Left = 26
        Top = 141
        Caption = 'Sitio de aplicaci'#243'n *'
        Transparent = True
      end
      object cxLookupComboBox15: TcxLookupComboBox
        Left = 26
        Top = 157
        ...
        Properties.ListSource = DM.DSsitios
        TabOrder = 23
        Width = 263
      end
      ...
      object cxLabel20: TcxLabel
        Left = 658
        Top = 101
        Caption = 'Categor'#237'a operativa *'
        Transparent = True
      end
      object cxLookupComboBox7: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DScatOp
        TabOrder = 25
        Width = 295
      end
    end
    object cxGroupBox3: TcxGroupBox
      ...
      object cxLookupComboBox6: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DSobjetivospaises
        TabOrder = 7
        Width = 217
      end
    end
    object cxGroupBox4: TcxGroupBox
      ...
      object cxLookupComboBox8: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DSmunicipios
        TabOrder = 17
        Width = 104
      end
      object cxLookupComboBox9: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DSprovincias
        TabOrder = 12
        Width = 121
      end
    ...
    object cxGroupBox5: TcxGroupBox
      ...
      object cxLookupComboBox10: TcxLookupComboBox
        ...
        Properties.ListSource = DM.DSorganismos
        EditValue = 'CAMARA COMERCIO'
        TabOrder = 4
        Width = 145
      end
    end
