...
type
  TFinformesorigen = class(TForm)
    cxGrid1: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    cxGridDBTableView1origeninforme: TcxGridDBColumn;
...
var
  Finformesorigen: TFinformesorigen;

implementation
  uses  UDM;
{$R *.dfm}

procedure TFinformesorigen.FormShow(Sender: TObject);
begin
