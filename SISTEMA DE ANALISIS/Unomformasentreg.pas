...
type
  TFnomformasentreg = class(TForm)
    cxGrid1: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    cxGridDBTableView1formaentrega: TcxGridDBColumn;
...
var
  Fnomformasentreg: TFnomformasentreg;

implementation
 uses UDM;
{$R *.dfm}

procedure TFnomformasentreg.FormShow(Sender: TObject);
begin
