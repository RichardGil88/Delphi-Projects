...
type
  TFidiomas = class(TForm)
    cxGrid1: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    cxGridDBTableView1idioma: TcxGridDBColumn;
    ...
    cxGridDBTableView1default: TcxGridDBColumn;
...
procedure TFidiomas.FormClose(Sender: TObject; var Action: TCloseAction);
begin
Action:=caFree;
end;

procedure TFidiomas.FormShow(Sender: TObject);
begin
