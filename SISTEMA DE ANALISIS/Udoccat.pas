...
type
  TFdoccat = class(TForm)
    cxGrid1: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    cxGridDBTableView1estadodedocumento: TcxGridDBColumn;
...
procedure TFdoccat.FormClose(Sender: TObject; var Action: TCloseAction);
begin
Action:=caFree;
end;

procedure TFdoccat.FormShow(Sender: TObject);
begin
